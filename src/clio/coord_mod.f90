...
!!      iLOVECLIM/CLIO is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License
!!      as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
!!
!!      iLOVECLIM/CLIO is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty
...
!
!>     @brief This module [coord_mod] is sharing the previous common declared variables in common "coord"
!
...
!-----|--1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2----+----3-|
      ...
      module coord_mod
        ...
        private :: imax, jmax
        ! NOTE this is only a public variable module
