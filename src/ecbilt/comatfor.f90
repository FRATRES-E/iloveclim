...
!
!>     @brief This module comatfor is Fortran90 replacement of comatfor.h
!
...
!-----|--1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2----+----3-|
      ...
      module comatfor
       ...
       use global_constants_mod, only: dblp=>dp, ip, sp

       implicit none

       private :: ip, sp, dblp, nlat, nlon

       public

       integer(ip)                        :: nocfile
       integer(ip)                        :: nbsatfor,nafyear
       real(kind=sp), dimension(nlat,nlon):: otempsg, odlrads, ouv10, owinstu, owinstv, oq10, otorain, orunofo, oevap
