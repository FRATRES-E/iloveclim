...
!-----|--1--------2---------3---------4---------5---------6---------7-|
           ...
           INTEGER, INTENT(IN) :: i_close, j_close, i_ism, j_ism, nx, ny&
                                 ,nw,nz,c
           REAL(KIND=8), DIMENSION(nx,ny,nw,0:nz), INTENT(OUT) :: data_int
...
!-----|--1--------2---------3---------4---------5---------6---------7-|
           ...
           ! zero-th index of data_int is the original point
           data_int(i_ism,j_ism,1,0) = i_close
           data_int(i_ism,j_ism,2,0) = j_close
           data_int(i_ism,j_ism,3,0) = 0.0d0
